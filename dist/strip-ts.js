...
export async function stripTSFromFile(filePath, outDir = 'output') {
    ...
    if (ext === '.ts' || ext === '.tsx') {
        ...
        try {
            ...
            let traverse = traverseModule;
            if (typeof traverseModule === 'object') {
                if (typeof traverseModule['default'] === 'function') {
                    traverse = traverseModule['default'];
                }
                else if (typeof traverseModule['default'] === 'object' &&
                    typeof traverseModule['default']['default'] === 'function') {
                    traverse = traverseModule['default']['default'];
                }
            }
            if (typeof traverse !== 'function') {
                console.error('Could not resolve traverse function. TraverseModule:', traverseModule, 'Type:', typeof traverse);
            ...
            if (typeof generateModule === 'object') {
                ...
                else if (typeof generateModule['default'] === 'object' &&
                    typeof generateModule['default']['default'] === 'function') {
                    generate = generateModule['default']['default'];
                }
            }
            if (typeof generate !== 'function') {
                console.error('Could not resolve generate function. GenerateModule:', generateModule, 'Type:', typeof generate);
